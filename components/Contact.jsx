...
const Contact = () => {
  ...
  const formRefSm = useRef();
  const formRefLg = useRef();

  const sendEmailSm = (e) => {
    e.preventDefault();

    emailjs
      .sendForm("service_8ygccq5", "template_x0umamz", formRefSm.current, {
  ...
  const sendEmailLg = (e) => {
    ...
    emailjs
      .sendForm("service_8ygccq5", "template_x0umamz", formRefLg.current, {
        publicKey: "LTWmJD5R0EXyn6OKZ",
      })
      .then(
        (result) => {
